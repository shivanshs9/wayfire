...
class wfs_hotspot : public noncopyable_t
{
  private:
    ...
    wf::geometry_t calculate_hotspot_geometry(
        wf::output_t* output, uint32_t edge_mask, uint32_t distance) const
    {
  ...
  public:
     ...
     */
    wfs_hotspot(wf::output_t* output, uint32_t edge_mask, uint32_t distance,
        uint32_t timeout, wl_client* client, uint32_t id)
    {
        ...
        wl_resource_set_implementation(
            hotspot_resource, NULL, this, handle_hotspot_destroy);
        ...
        wf::get_core().output_layout->connect_signal(
            "output-removed", &on_output_removed);
    }
...
class wfs_output : public noncopyable_t
{
    ...
    void disconnect_from_output()
    {
        ...
        output->disconnect_signal(
            "fullscreen-layer-focused", &on_fullscreen_layer_focused);
    }
    ...
    wf::signal_callback_t on_fullscreen_layer_focused =
  ...
  public:
    wfs_output(wf::output_t* output, wl_client* client, int id)
    {
        ...
        wl_resource_set_implementation(
            resource, &zwf_output_impl, this, handle_output_destroy);
...
class wfs_surface : public noncopyable_t
{
  ...
  public:
    wfs_surface(wayfire_view view, wl_client* client, int id)
    {
        ...
        wl_resource_set_implementation(
            resource, &zwf_surface_impl, this, handle_surface_destroy);
...
static void zwf_shell_manager_get_wf_output(
    wl_client* client, wl_resource* resource, wl_resource* output, uint32_t id)
{
...
static void zwf_shell_manager_get_wf_surface(
    wl_client* client, wl_resource* resource, wl_resource* surface, uint32_t id)
{
