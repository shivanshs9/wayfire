...
static void handle_gtk_surface_set_dbus_properties(wl_client*,
    wl_resource* resource, const char* application_id, const char*, const char*,
...
{}
static void handle_gtk_surface_unset_modal(
    wl_client* client, wl_resource* resource)
{}
static void handle_gtk_surface_present(
    wl_client* client, wl_resource* resource, uint32_t time)
{}
...
static void handle_gtk_shell_get_gtk_surface(
    wl_client* client, wl_resource* resource, uint32_t id, wl_resource* surface)
{
    auto res = wl_resource_create(
        client, &gtk_surface1_interface, wl_resource_get_version(resource), id);
    wl_resource_set_implementation(
        res, &gtk_surface1_impl, surface, handle_gtk_surface_destroy);
}

static void handle_gtk_shell_set_startup_id(
    wl_client* client, wl_resource* resource, const char* startup_id)
{}
static void handle_gtk_shell_system_bell(
    wl_client* client, wl_resource* resource, wl_resource* surface)
{}
...
void bind_gtk_shell1(wl_client* client, void* data, uint32_t version, uint32_t id)
{
    ...
    wl_resource_set_implementation(
        resource, &gtk_shell1_impl, NULL, handle_gtk_shell1_destroy);
}

wf_gtk_shell* wf_gtk_shell_create(wl_display* display)
{
    if (wl_global_create(
            display, &gtk_shell1_interface, 1, NULL, bind_gtk_shell1) == NULL)
    {
...
std::string wf_gtk_shell_get_custom_app_id(
    wf_gtk_shell* shell, wl_resource* surface)
{
