...
wf::tablet_tool_t::tablet_tool_t(
    wlr_tablet_tool* tool, wlr_tablet_v2_tablet* tablet)
{
    ...
    this->tool_v2 = wlr_tablet_tool_create(
        core.protocols.tablet_v2, core.get_current_seat(), tool);
    ...
    wf::get_core().connect_signal(
        "_surface_mapped", &on_surface_map_state_changed);
    wf::get_core().connect_signal(
    ...
    wf_input_device_internal(dev)
{
    ...
    auto& core = wf::get_core_impl();
    tablet_v2 =
        wlr_tablet_create(core.protocols.tablet_v2, core.get_current_seat(), dev);
